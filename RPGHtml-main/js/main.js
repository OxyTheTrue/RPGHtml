...
function bindMenuAndSidebar() {
    ...
    const closeSkillTreeBtn = document.querySelector('[data-action="close-skill-tree"]');
    if (closeSkillTreeBtn) closeSkillTreeBtn.addEventListener('click', () => game.closeAllModals());
